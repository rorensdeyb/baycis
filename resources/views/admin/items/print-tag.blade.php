...
<body>
    ...
    <div class="tag-container">
        <div class="tag-header">{{ $item->supplier->name ?? 'N/A' }}</div>
        ...
        <div class="tag-body">
            <div class="left-panel">
                ...
                <div class="barcode-placeholder">
                    <img id="print-barcode" style="width: 100%; height: auto; max-height: 45px; object-fit: contain;"/>
                    <br>
    ...
    <script>
        window.onload = function() {
            // Generates and assigns base64 data strings natively onto <img> src structures
            JsBarcode("#print-barcode", "{{ $item->property_tag }}", {
                format: "CODE128",
                lineColor: "#000",
                width: 1.5, 
                height: 40,
            ...
            // Gave it a 500ms safety window to let the src stream settle completely
            setTimeout(function() {
                window.print();
            }, 500);
        };
